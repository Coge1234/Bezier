...
public class AdhesionHorizontalLoader extends View {
    ...
    public AdhesionHorizontalLoader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AdhesionHorizontalLoader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        for (int i = 0; i < mStaticCircleCount; i++) {
            ...
            mStaticCircle.x = (mStaticCircle.radius * 2 + mDivideWidth) * (i + 1) + mStaticCircle.radius;
    ...
    private void startAnim() {
        ...
        //动画效果重复
        xValueAnimator.setRepeatMode(ValueAnimator.REVERSE);
