package com.example.jochen.bezier.widget.adhesion.progress;
...
public class AdhesionCircleLoader extends View {
    ...
    public AdhesionCircleLoader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AdhesionCircleLoader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
         ...
         */
        setMeasuredDimension(resolveSizeAndState(mWidth, widthMeasureSpec, MeasureSpec.UNSPECIFIED),
                resolveSizeAndState(mHeight, heightMeasureSpec, MeasureSpec.UNSPECIFIED));
    }
    ...
    private boolean doAdhere(int position) {
        ...
        Log.i("AdhesionCircleLoader", "doAdhere: " + mMaxAdherentLength);
        /* 判断是否可以作贝塞尔曲线 */
